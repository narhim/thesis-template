...
% Set up the document
\documentclass[a4paper, 11pt, oneside]{Thesis}  % Use the "Thesis" style defined in Thesis.cls
...
\supervisor  {Prof. Vera Demberg \\ Dr. Lucia Donatelli}
\inmatricul  {2581298}
...
\loadappendix{AppendixA}{Additional Scores}
